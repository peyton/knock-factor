...
public class KnockEventListener implements SensorEventListener {
    ...
    private static final float ACCELERATION_BASE = 9.81f; // m/s

    /**
     * When the magnitude of total acceleration exceeds this
     * value, the phone is accelerating.
     */
    private static final float ACCELERATION_THRESHOLD = 2;
    ...
    public KnockEventListener(Listener listener) {
    ...
    private boolean isAccelerating(SensorEvent event) {
        ...
        return magnitude > ACCELERATION_BASE + ACCELERATION_THRESHOLD || magnitude < ACCELERATION_BASE - ACCELERATION_THRESHOLD;
    }
